...
def preview():
    ...
    html = html.replace(
        "</body>",
        '<script src="/static/mobile-preview.js?v=8" defer></script><script src="/static/video-audio-state.js?v=5" defer></script><script src="/static/lylo-voice.js?v=5" defer></script></body>'
    )
